...
{
    private const int CreditsTitleFontSize = 40;
    private const int CreditsBodyFontSize = 30;

    [Header("Credits")]
    [SerializeField] private TextMeshProUGUI _creditsText;
    [SerializeField] private RectTransform _creditsContent;
    [SerializeField] private float _scrollDuration = 30.0f;
    ...
    private void SetCreditsText()
    {
        ...
        _creditsText.fontSize = CreditsBodyFontSize;
    ...
    private void ResizeCreditsText()
    {
        ...
        if (_creditsContent != null)
        {
            ...
            float startY = -_scrollPaddingY;
            float scrollDistance = _endY - startY;
            _scrollSpeed = scrollDistance / Mathf.Max(_scrollDuration, 0.01f);
        }
    }
    ...
    {
        sb.AppendLine($"<size={CreditsTitleFontSize}>{title}</size>");
        sb.AppendLine();
    }
