...
public class DeviceInputManager : MonoBehaviour
{
    ...
    public bool IsMenuPopup { get; private set; }
    private bool _isHandlingBackAction;
    private bool _isSaving;
    private bool _wasLoading;

    private void Update()
    {
        if (Managers.Scene.IsLoding)
        {
            if (!_wasLoading)
            {
                ClearBackButtonActions();
    ...
    public void ClearBackButtonActions()
    {
        _backButtonActions.Clear();
    }

    public void SetMenuPopupState(bool isOpen)
    {
        IsMenuPopup = isOpen;
    }
